...
const Overview = (props) => {
  const [product, setProduct, allStyles, updateAllStyles] = useContext(OverviewContext);

  return (
    <div id="product-overview">
      <OverviewAnnouncement />
      <div className="po-flex">
        <OverviewGallery product={product} />
        <OverviewDetails product={product} setProduct={setProduct} allStyles={allStyles} updateAllStyles={updateAllStyles} />
      </div>
    </div>
  );
};
